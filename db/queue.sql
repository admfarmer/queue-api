/*
 ...
 Source Schema         : queue_moph

 Target Server Type    : MySQL
 Target Server Version : 100014
 File Encoding         : 65001

 Date: 06/03/2019 20:02:40
*/
...
CREATE TABLE `q4u_departments`  (
  ...
  `department_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `q4u_priorities`  (
  ...
  `priority_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `priority_prefix` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `prority_color` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `q4u_provider_types`  (
  ...
  `provider_type_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'รหัสประเภทผู้ให้บริการ',
...
CREATE TABLE `q4u_queue`  (
  ...
  `priority_id` int(3) NULL DEFAULT NULL,
  `room_id` int(2) NULL DEFAULT NULL COMMENT 'ช่องบริการ',
  `date_serv` date NOT NULL COMMENT 'วันที่รับบริการ',
  `time_serv` time(0) NULL DEFAULT NULL,
  `queue_number` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'หมายเลขQ',
  `queue_running` int(6) NULL DEFAULT 0,
  `his_queue` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'หมายเลขQ(Hosxp)',
  `queue_status_id` int(1) NULL DEFAULT NULL COMMENT 'สถานะQ',
  `mark_pending` enum('N','Y') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'N' COMMENT 'N=Not pending Y=pending',
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'หมายเหตุรับบริการ',
  `date_create` datetime(0) NOT NULL COMMENT 'เวลาสร้างQ',
  `date_update` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0) COMMENT 'เวลาปรับปรุ่งQ',
  `pending_to_service_point_id` int(3) NULL DEFAULT NULL COMMENT 'แผนกที่ถูกส่งคิวต่อ',
  `is_interview` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'N',
  `is_completed` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'N',
  `queue_interview` int(11) NULL DEFAULT NULL COMMENT 'ลำดับคิวในการซักประวัติ',
  `is_cancel` enum('Y','N') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'N',
  PRIMARY KEY (`queue_id`) USING BTREE,
  UNIQUE INDEX `q4u_queue_un`(`queue_id`) USING BTREE
...
CREATE TABLE `q4u_queue_number`  (
  `service_point_id` int(3) NOT NULL,
  `date_serv` date NOT NULL,
  `current_queue` int(11) NULL DEFAULT 0,
  `update_date` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
...
CREATE TABLE `q4u_queue_status`  (
  ...
  `queue_status_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `queue_status_desc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `q4u_service_point_prefix`  (
  ...
  `service_point_status_id` int(3) NULL DEFAULT 1 COMMENT '0=ไม่ใช้งาน 1=ใช้าน ',
...
CREATE TABLE `q4u_service_points`  (
  ...
  `service_point_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'ชื่อจุดบริการ',
  `service_point_abbr` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'ชื่อย่อจุดบริการ',
  `local_code` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'รหัสที่ใช้ภายในสถานพยาบาล',
  `standard43_code` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'รหัส clinic ตามมาตรฐาน 43 แฟ้ม',
  `service_point_type_id` int(3) NULL DEFAULT NULL COMMENT 'รหัสประเภทจุดบริการ',
  `topic` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'publisher ของ mqtt (กรณี h4udb hdc+topic_h4u)',
  `prefix` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `department_id` int(3) NULL DEFAULT NULL COMMENT 'แผนก',
  `kios` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'N',
  `use_old_queue` enum('Y','N') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'N',
  `group_compare` enum('Y','N') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'N' COMMENT 'เชื่อมคิวกลุ่มกับตารางคิว Y=แก้ไขตารางคิว N=ไม่แก้ไขตารางคิว',
  PRIMARY KEY (`service_point_id`) USING BTREE,
  UNIQUE INDEX `service_point_un_point_name`(`service_point_name`) USING BTREE,
  UNIQUE INDEX `idx_topic`(`topic`) USING BTREE,
  UNIQUE INDEX `idx_prefix`(`prefix`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `q4u_service_rooms`  (
  ...
  `room_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'ชื่อห้องตรวจ',
  `room_id` int(6) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`service_point_id`, `room_number`) USING BTREE,
  UNIQUE INDEX `service_rooms_un`(`room_id`) USING BTREE
...
CREATE TABLE `q4u_system`  (
  ...
  `hosname` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`hoscode`) USING BTREE,
  UNIQUE INDEX `idx_hoscode`(`hoscode`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `q4u_user_roles`  (
  ...
  `is_active` int(1) NULL DEFAULT 1 COMMENT '0=ยกเลิก 1=ใช้งาน',
...
CREATE TABLE `q4u_user_service_points`  (
  ...
  `service_point_id` int(3) NOT NULL,
  PRIMARY KEY (`user_id`, `service_point_id`) USING BTREE,
  UNIQUE INDEX `use_service_point_id`(`user_service_point_id`) USING BTREE
...
CREATE TABLE `q4u_users`  (
  ...
  `is_active` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'Y',
  `user_type` enum('ADMIN','MEMBER') CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`user_id`) USING BTREE,
  UNIQUE INDEX `idx_username`(`username`) USING BTREE,
  INDEX `idx_password`(`password`(255)) USING BTREE,
